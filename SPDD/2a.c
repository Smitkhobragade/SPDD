...
int _stdcall WinMain(HINSTANCE hinstance, HINSTANCE hPrevinstance, LPSTR IpszCmdline, int nCmdShow)
{
  ...
  h[2] = CreateWindow("BUTTON",
                      "MINIMIZEBOX", WS_OVERLAPPEDWINDOW | WS_MINIMIZEBOX, 200, 200, 150, 100, 0, 0, hinstance, 0);
  ShowWindow(h[2], nCmdShow);
  h[3] = CreateWindow("BUTTON",
                      "VSCROLL", WS_VSCROLL, 300, 300, 150, 100, 0, 0, hinstance, 0);
  ShowWindow(h[3], nCmdShow);
  h[4] = CreateWindow("BUTTON",
                      "SYSMENU",
                      WS_SYSMENU, 400, 400, 150, 100, 0, 0, hinstance, 0);
